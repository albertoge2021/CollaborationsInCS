...
from functions.concepts import concept_analysis
from functions.hdi import hdi_analysis
from functions.languages import language_analysis

from functions.number_of_publications_and_citations import (
    number_of_publications_and_citations,
)
